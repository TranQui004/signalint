...
| CI tests only Node 22.x although `package.json` promises Node 20.19+ support (external security audit, 2026-07-31) | Resolved pre-launch: retain the Node 22 cross-platform matrix and add an Ubuntu Node 20.19 compatibility job |
